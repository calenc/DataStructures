...
//	Description:       Class demo showing #region, properties, override, and 
//							XML comments
...
{
    /// <summary>
    /// Class MilesPerGallon computes the mileage per gallon of fuel from a starting point 
    /// to an end point of a trip, and it illustrates properties, overriding the ToString
    /// method inherited from Object, throwing an exception if necessary, and interpolated 
    /// strings
    /// </summary>
